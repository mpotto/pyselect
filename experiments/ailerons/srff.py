...
X, y = data[:, 0:39], data[:, 39].reshape(-1, 1)
...
# 8) Save results.
np.savetxt("experiments/ailerons/results/srff_precisions.txt", precisions)
np.savetxt("experiments/ailerons/results/srff_results.txt", results)
joblib.dump(test, "experiments/ailerons/models/test.joblib")
