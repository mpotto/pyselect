...
model = ReluRFFNetRegressor(
    lr=1e-3,
    hidden_layer_size=(500, 100, 50, 20),
    torch_seed=seed,
    random_state=0,
    n_iter_no_change=20,
    verbose=True,
...
# Save results
relevances_folder = get_folder("eval/benchmarks/rffnetp/ailerons/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnetp/ailerons/metrics")
models_folder = get_folder("eval/benchmarks/rffnetp/ailerons/models")
