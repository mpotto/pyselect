...
np.savetxt(f"experiments/yearpredictionmsd/results/srff_precisions.txt", precisions)
joblib.dump(train_results, f"experiments/yearpredictionmsd/models/reg_srff.joblib")
...
# 8) Save results.
np.savetxt("experiments/yearpredictionmsd/results/srff.txt", results)
