...
y_train = np.load("data/yearpredictionmsd/processed/y_train.npy")
y_val = np.load("data/yearpredictionmsd/processed/y_val.npy")
y_test = np.load("data/yearpredictionmsd/processed/y_test.npy")
...
# 8) Save results.
np.savetxt("experiments/yearpredictionmsd/results/ard_results.txt", results)
np.savetxt(
    "experiments/yearpredictionmsd/results/ard_precisions.txt",
    best_model.lambda_,
)
joblib.dump(best_model, "experiments/yearpredictionmsd/models/ard_rff.joblib")
