...
# 8) Save results.
np.savetxt("experiments/compact/results/srff_precisions.txt", precisions)
np.savetxt("experiments/compact/results/srff_results.txt", results)
joblib.dump(test, "experiments/compact/models/srff.joblib")
