...
# Results
precisions_folder = get_folder("eval/benchmarks/rffnetp/higgs/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnetp/higgs/metrics")
models_folder = get_folder("eval/benchmarks/rffnetp/higgs/models")
