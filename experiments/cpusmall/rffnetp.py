...
# Save results
relevances_folder = get_folder("eval/benchmarks/rffnetp/cpusmall/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnetp/cpusmall/metrics")
models_folder = get_folder("eval/benchmarks/rffnetp/cpusmall/models")
