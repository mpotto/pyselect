...
# Save results
relevances_folder = get_folder("eval/benchmarks/rffnet_scaling/se2/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnet_scaling/se2/metrics")
models_folder = get_folder("eval/benchmarks/rffnet_scaling/se2/models")
