...
# Save results
relevances_folder = get_folder("eval/benchmarks/rffnetp/se2/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnetp/se2/metrics")
models_folder = get_folder("eval/benchmarks/rffnetp/se2/models")
