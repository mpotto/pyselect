...
np.savetxt(
    "experiments/gregorova/se2/results/ard_precisions.txt",
    best_model.lambda_,
)

joblib.dump(best_model, "experiments/gregorova/se2/models/reg_ard.joblib")

np.savetxt("experiments/gregorova/se2/results/ard.txt", np.array(results))
