...
np.savetxt(f"experiments/gregorova/se2/results/srff_precisions.txt", precisions)
joblib.dump(test, f"experiments/gregorova/se2/models/reg_srff.joblib")
...
# 8) Save results.
np.savetxt("experiments/gregorova/se2/results/srff.txt", results)
