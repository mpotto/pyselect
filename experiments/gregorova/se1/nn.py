...
# Save results
relevances_folder = get_folder("eval/benchmarks/nn/se1/precisions")
metrics_folder = get_folder("eval/benchmarks/nn/se1/metrics")
models_folder = get_folder("eval/benchmarks/nn/se1/models")
