...
# Save results
relevances_folder = get_folder("eval/benchmarks/rffnetp/se1/precisions")
metrics_folder = get_folder("eval/benchmarks/rffnetp/se1/metrics")
models_folder = get_folder("eval/benchmarks/rffnetp/se1/models")
