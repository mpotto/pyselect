...
# Save results
relevances_folder = get_folder("eval/benchmarks/ard/se1/precisions")
metrics_folder = get_folder("eval/benchmarks/ard/se1/metrics")
models_folder = get_folder("eval/benchmarks/ard/se1/models")
